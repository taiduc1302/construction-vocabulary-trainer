...
for(const term of terms){
  ...
  if(!phraseIncluded(term.example_en,term.term))warnings.push(`${term.id}: example_en does not contain the exact term phrase; verify this is intentional`);
...
console.log(`Content audit OK: ${terms.length} terms checked for structure, answer leakage, canonical duplicates and focus metadata.`);
